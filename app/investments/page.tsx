...
export default function InvestmentsPage() {
  ...
  const filteredInvestments = investments.filter(
    (investment) =>
      !selectedCategory || investment.category === selectedCategory,
  );
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 md:pt-40" role="region" aria-label="Investments page content">
        <motion.div
        ...
        >
          <div className="space-y-4">
            ...
            <p className="mx-auto max-w-[700px] text-gray-500 ">
              We have made a range of investments - primarily at early stage -
              into exciting entrepreneurs who are seeking to scale excellent
              products/services into their chosen markets. Where we can support,
              we mainly help the management teams on sales, fundraising and
              recruitment.
            </p>
          </div>
