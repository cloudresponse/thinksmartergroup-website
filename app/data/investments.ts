...
import blokLogo from "@/app/images/investment-logos/blok-logo.png";
...
import perplexityLogo from "@/app/images/investment-logos/perplexity-logo.png";
import polariLogo from "@/app/images/investment-logos/polari-logo.png";
...
import {
  type Investment,
  InvestmentCategory,
} from "@/lib/interfaces/investment";
...
export const investments: Investment[] = [
  {
    ...
    imageSrc: perplexityLogo.src,
    category: InvestmentCategory.AI_SAAS,
  },
  {
    title: "Pango",
    description:
      "Pango is a platform that allows you to create and manage your own AI agents.",
    href: "https://www.imaginelearning.com/press/imagine-learning-acquires-pango-education-to-advance-ai-powered-personalized-k-12-solutions/",
  ...
  },
  {
    title: "Box Media",
    description:
      "Box Media is a technology-first company dedicated to transforming how industries distribute, monetize, and scale knowledge assets through advanced automation, blockchain integration, and innovative content infrastructure.",
  ...
  },
  {
    title: "UnSchool",
    description:
      "Intern with a well-established corporate space that will add value to your resume and can help you get placed with bigger opportunities.",
  ...
  },
  {
    title: "SignUp Media",
    description:
      "SignUp Mediais revolutionizing media accessibility for the Deaf community.",
  ...
  },
  {
    title: "Scan.com",
    description:
      "At Scan.com, we're delivering the highest standards of care, and making medical imaging accessible to patients and clinicians across the country.",
    href: "https://scan.com/",
  ...
  },
  {
    ...
    description:
      "Thermology Health, a spinout from the UK's National Metrology Institute, the National Physical Laboratory (NPL), is transforming diagnostic healthcare through thermal imaging.",
  ...
  },
  {
    title: "MV.Health",
    description:
      "Clinically-proven devices that adapt to the body & deliver targeted vibrations to address major Uro-Gyn issues.",
  ...
  },
  {
    ...
    description:
      "The modern workforce solution for UK healthcare. Asterix Health improves access and lowers costs for primary care providers. ",
  ...
  },
  {
    title: "AutogenAI",
    description:
      "Harness the power of augmented intelligence to write high-quality, winning bids, tenders, proposals and grants faster than ever.",
  ...
  {
    title: "Blok",
    description: "Make product decisions based on science not hunches",
    href: "https://www.joinblok.co/",
    imageSrc: blokLogo.src,
    category: InvestmentCategory.AI_SAAS,
  },
  {
    title: "Stackfix",
    description:
      "Find the right software, tested by real experts. We test and rate every tool, so you don't have to.",
  ...
  },
  {
    title: "Foundy",
    description:
      "Foundy leverages expert advisors, advanced AI technology and a database of over 1 million transactions to provide business owners and corporate finance firms the most optimal route to a successful acquisition",
  ...
  },
  {
    title: "Beeline",
    description:
      "Our story started in 2015 when our co-founders Tom and Mark got lost on their bicycles. They spotted a gap in the market for a simple navigation product that gives people on two wheels (whether that is a bicycle or a motorcycle!) all the information they need for a safe and enjoyable ride; nothing more.",
  ...
  },
  {
    title: "Green Lithium",
    description:
      "We are advancing a low-carbon, flexible output lithium project that will address the £14bn European market by unlocking the critical minerals supply shortfall holding back the continent’s battery and EV production",
  ...
  },
  {
    title: "Starship",
    description:
      "We're revolutionising last-mile delivery, making it affordable and sustainable on a global scale.",
  ...
  },
  {
    ...
    description:
      "We are dedicated to consolidating businesses that specialize in providing accounting, tax, payroll, and HR services to small and medium enterprises. ",
    href: "https://www.ampliacapital.co.uk/",
    imageSrc: ampliaCapitalLogo.src,
    category: InvestmentCategory.Rollups,
  },
  {
    title: "Yolk",
    description:
      "Another day, another blandwich. Another drab, grab-and-go meal. Somewhere along the way, the high street sucked the fun out of food.",
  ...
  },
  {
    title: "aasaan will",
    description:
      "India's favorite Will writing service. Save 90% in time and cost. Ensure your life's work is protected and cherished. Get your Will in 3 simple steps.",
